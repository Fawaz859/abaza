...
if not msg.SudoBase then return "✦¹  هذا الامر يخص {المطور الاساسي} فقط  \n" end
local GetVerison = https.request('https://raw.githubusercontent.com/Fawaz859/Fawaz859.github.io/main/GetVersion.txt') or "0"
...
local Get_Files, res = https.request("https://raw.githubusercontent.com/Fawaz859/abaza/main/plugins/"..FileName)
if res == 200 then
